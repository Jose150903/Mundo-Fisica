namespace Boceto_proyecto
{
    partial class TVCL
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnTVCL.Location = new Point(313, 72);
            ...
            btnMCUV.Location = new Point(316, -1);
            ...
            btnMCU.Location = new Point(163, 72);
            btnMCU.Name = "btnMCU";
            ...
            btnMRUV.Location = new Point(163, -1);
            ...
            btnMRU.Location = new Point(2, 72);
            btnMRU.Name = "btnMRU";
            ...
            btnAtras.Location = new Point(336, 346);
            ...
            btnContinuar.Location = new Point(498, 346);
            ...
            // lbTVInfo
            // 
            lbTVInfo.BackColor = Color.Transparent;
            lbTVInfo.Font = new Font("Arial", 12F, FontStyle.Bold | FontStyle.Italic, GraphicsUnit.Point, 0);
            lbTVInfo.ForeColor = SystemColors.ControlText;
            lbTVInfo.Location = new Point(12, 150);
            lbTVInfo.Name = "lbTVInfo";
            lbTVInfo.Size = new Size(298, 100);
            lbTVInfo.TabIndex = 42;
            lbTVInfo.Text = "El Tiro Vertical es el movimiento provocado a un cuerpo en el que éste se va a desplazar en línea recta, de manera vertical, ya sea para arriba o para abajo.";
            // 
            // lblCLInfo
            // 
            lblCLInfo.BackColor = Color.Transparent;
            lblCLInfo.Font = new Font("Arial", 12F, FontStyle.Bold | FontStyle.Italic, GraphicsUnit.Point, 0);
            lblCLInfo.ForeColor = SystemColors.ControlText;
            lblCLInfo.Location = new Point(321, 216);
            lblCLInfo.Name = "lblCLInfo";
            lblCLInfo.Size = new Size(298, 78);
            lblCLInfo.TabIndex = 43;
            lblCLInfo.Text = "Se le llama caída libre al movimiento que se debe únicamente a la influencia de la gravedad";
            // 
            // TVCL
            // 
            ...
            Controls.Add(lblCLInfo);
            Controls.Add(lbTVInfo);
        ...
        private Label lbTVInfo;
        private Label lblCLInfo;
    }
}